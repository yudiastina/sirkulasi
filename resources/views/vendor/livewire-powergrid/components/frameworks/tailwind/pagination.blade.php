                        ...
                        @if (is_array($element))
                            ...
                            @foreach ($element as $page => $url)
                                ...
                                @if ($page == $paginator->currentPage())
                                    <span
                                        class="px-2 py-1 m-1 text-center border-gray-400 rounded cursor-pointer border-1 dark:bg-gray-700 dark:text-white">{{ $page }}</span>
            ...
            @if ($paginator->hasPages() && $recordCount == 'min')
                <nav role="navigation" aria-label="Pagination Navigation" class="items-center justify-between sm:flex">
                    ...
                    <span>
                        ...
                        @if ($paginator->onFirstPage())
                            <button disabled
                                    class="p-2 m-1 text-center text-gray-400 bg-gray-200 border-gray-400 rounded border-1 dark:text-gray-300">
                                <x-livewire-powergrid::icons.chevron-double-left/>
                            </button>
                        @else
                            @if(method_exists($paginator,'getCursorName'))
                                <button
                                    ...
                                    class="p-2 m-1 text-center text-white bg-gray-500 border-gray-400 rounded cursor-pointer border-1 hover:bg-gray-600 hover:border-gray-800 dark:text-gray-300">
                                        <x-livewire-powergrid::icons.chevron-double-left/>
                                </button>
                            @else
